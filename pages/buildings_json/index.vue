    ...
    <div class="row">
      <div class="twelve columns">
        <div class="page-header">
          <h1 class="page-title">Ranking de edificios más altos del mundo</h1>
          <p class="page-subtitle">Datos desde archivo JSON</p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="twelve columns">
        <div class="buildings-grid">
          <div v-for="e in items" :key="e.num" class="building-card">
            <NuxtLink :to="`/buildings_json/${e.num}`" class="card-link">
              <div class="card-minimal">
                <div class="card-ranking">
                  <span class="ranking-number">{{ e.num }}</span>
                </div>
                <div class="card-body">
                  <h3 class="building-title">{{ e.name }}</h3>
                  <div class="building-meta">
                    <span class="height-indicator">{{ e.altura_m }}m</span>
                    <span class="meta-location">{{ e.city }}</span>
                  </div>
                </div>
